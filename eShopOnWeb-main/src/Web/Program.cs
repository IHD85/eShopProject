...
builder.Services.AddHttpClient<CatalogDataService>(client =>
{
    client.BaseAddress = new Uri(baseUrlConfig!.MicroserviceGatewayBase);
});
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var dataService = scopedProvider.GetRequiredService<CatalogDataService>();
